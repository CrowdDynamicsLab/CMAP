...
public:
	string model_type = "CMAP_FACTORED";
...
public:
	...
	CMAP_FACTORED(int _G = 20, int _K_b = 5, int _K_w = 20, double _discount = 0.5, double _scale = 1.5)
	{
		this->G = _G;
		this->K_b = _K_b;
		this->K_w = _K_w;
	...
	void compute_beta_distribution(int itr)
	{
		...
		if(itr != 0)
		{
			...
			for(int u = 0; u < U; ++u)
			{
				...
				// topic_ts[curr_topic].push_back(curr_ts);
			}
...
// 	if(argc < 4)
// 	{
// 		cout<<"Usage "<<argv[0]<<" dataset G K_w"<<endl;
// 		exit(1);
// 	}
